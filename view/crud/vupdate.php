            ...
            <form method="POST" action="<?php echo $var['CRUDROUTE'] . 'update'; ?>">
                <?php foreach ($var['RESULT']['NAMEPOST'] as $key => $value): ?>
                    <div class="form-group">
                        ...
                        <input <?php echo ($value['Key'] === 'PRI') ? 'readonly=""' : ''; ?> name="<?php echo $value['Field']; ?>" type="text" class="form-control" placeholder="" required="" value="<?php echo $var['RESULT']['DATA'][$value['Field']]; ?>">
                    </div>
                <?php endforeach; ?>
